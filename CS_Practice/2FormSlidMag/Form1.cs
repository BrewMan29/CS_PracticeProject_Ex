...
namespace _2FormSlidMag
{
    ...
    public partial class Form1 : Form
    {
        ...
        public static bool flag01; // Form2가 열렸는지 판단
        public static bool flag02; // Form3가 열렸는지 판단
        public static bool flag03; // Form3가 붙어있는지 판단
        ...
        {
            if(flag01 == false) // Form2가 닫혀있을 때 생성
            {
        ...
        {
            if(flag02 == false) //폼3이 닫혀 있을 때 실행
            {
                this.btnMag.Text = "폼 붙이기 닫기";
                frm3.Show();
                flag02 = true; flag03 = true;
                frm3.Location = new Point(this.Location.X, this.Location.Y + 310);
            }
            else
            {
